...
public class AssetViewMasterRestModel {
	...
	private List<ManageTrainingRestDocumentModel> documentList;
	public AssetViewMasterRestModel() {
		super();
	...
	public List<ManageTrainingRestDocumentModel> getDocumentList() {
		return documentList;
	}

	public void setDocumentList(List<ManageTrainingRestDocumentModel> documentList) {
