...
public class LocationMasterRestController {
	...
	@RequestMapping(value = "delete-location-Details", method = { RequestMethod.GET })
	public ResponseEntity<JsonResponse<Object>> deleteLocatioinDetails(@RequestParam String id) {
		logger.info("Method :  deleteLocatioinDetails starts"+id);

		logger.info("Method :  deleteLocatioinDetails ends");
		return locationMasterDao.deleteLocatioinDetails(id);
	}
}
