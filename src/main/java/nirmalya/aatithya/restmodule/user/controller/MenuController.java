...
public class MenuController {
	...
	// Web - AccessController
	@GetMapping(value = "get-breadcrumb-data")
	public ResponseEntity<JsonResponse<BreadcrumbModel>> getRestBreadcrumbData(@RequestParam String modId,
			@RequestParam String funId, @RequestParam String actId) {
		logger.info("Method : getRestBreadcrumbData starts");

		logger.info("Method : getRestBreadcrumbData ends");
		return menuDao.getRestBreadcrumbData(modId, funId, actId);
	}
}
