 ...
 *
 */
public class RestContraVoucherModel {
	...
	public RestContraVoucherModel() {
		super();
		// TODO Auto-generated constructor stub
	}

	public RestContraVoucherModel(Object contraVoucherId, Object contraVoucherType, Object costCenterType,
			Object contraVoucherDate, Object amount, Object debAccGroupId, Object debitedAccGroup, Object creAccGroupId,
			Object creditedAccGroup, Object fromAccountB2BId, Object fromAccountB2B, Object toAccountB2BId,
			Object toAccountB2B, Object fromBankB2CId, Object fromBankB2C, Object toCashB2C, Object fromCashC2B,
			Object toBankC2BId, Object toBankC2B, Object fromCashC2C, Object toCashC2C, Object description,
		...
		this.costCenterType = (String) costCenterType;
		this.contraVoucherDate = (String) contraVoucherDate;
		this.amount = (String) amount;

		this.debAccGroupId = (String) debAccGroupId;
		this.debitedAccGroup = (String) debitedAccGroup;
		this.creAccGroupId = (String) creAccGroupId;
		this.creditedAccGroup = (String) creditedAccGroup;

		this.fromAccountB2BId = (String) fromAccountB2BId;
		this.fromAccountB2B = (String) fromAccountB2B;
		this.toAccountB2BId = (String) toAccountB2BId;
		this.toAccountB2B = (String) toAccountB2B;
		this.fromBankB2CId = (String) fromBankB2CId;
		this.fromBankB2C = (String) fromBankB2C;
		this.toCashB2C = (String) toCashB2C;

		this.fromCashC2B = (String) fromCashC2B;
		this.toBankC2BId = (String) toBankC2BId;
		this.toBankC2B = (String) toBankC2B;
		this.fromCashC2C = (String) fromCashC2C;
		this.toCashC2C = (String) toCashC2C;
	...
	/*
	 * (Object contraVoucherId, Object contraVoucherType, Object costCenter, Object
	 * cvDescription, Object cvDate, Object cvAmount)
	 */

	public RestContraVoucherModel(Object contraVoucherId, Object contraVoucherType, Object costCenter,
			Object description, Object contraVoucherDate, Object amount) {
		super();
		this.contraVoucherId = (String) contraVoucherId;
		this.contraVoucherType = (String) contraVoucherType;
	...
	public RestContraVoucherModel(Object debAccGroupId, Object debitedAccGroup,Object amount) {
		super();
		this.debAccGroupId = (String) debAccGroupId;
		this.debitedAccGroup = (String) debitedAccGroup;
		this.amount = (String) amount;
	...
	public RestContraVoucherModel(Object accountId, Object accountNo, Object accountBank, Object accountBranch) {
		super();
		this.accountId = (String) accountId;
		this.accountNo = (String) accountNo;
		this.accountBank = (String) accountBank;
		this.accountBranch = (String) accountBranch;
